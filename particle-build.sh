...
DEVICE="p2"
DEVICE_ID="32"
DEVICE_OS_VERSION="5.3.2"
BUILD_PATH=$HOME/.particle/toolchains/deviceOS/$DEVICE_OS_VERSION
BUILDSCRIPT="$HOME/.particle/toolchains/buildscripts/1.12.0/Makefile"
PROJECT_PATH=${PWD}
...
APP_FLAGS+="-DEI_CLASSIFIER_TFLITE_ENABLE_CMSIS_NN=1 "
APP_FLAGS+="-DEI_CLASSIFIER_TFLITE_LOAD_CMSIS_NN_SOURCES=1 "
APP_FLAGS+="-DARM_MATH_LOOPUNROLL"
